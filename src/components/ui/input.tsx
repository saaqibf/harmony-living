...
export function Input({ className, type, ref, ...props }: InputProps) {
  return (
    <input
      ...
      type={type ?? 'text'}
      className={cn(
        'flex min-h-11 w-full rounded-lg border border-[#cfc5bd] bg-[#F5EAE4] px-4 py-2 text-sm text-[#1c1b1b] placeholder:text-[#7d766f] transition-colors',
        ...
        'disabled:cursor-not-allowed disabled:bg-[#EFE0D8] disabled:text-[#7d766f]',
