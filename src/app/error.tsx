...
export default function GlobalError({
  ...
  return (
    <div className="min-h-screen bg-[#fdf8f7] flex flex-col items-center justify-center px-6 text-center">
      <div className="w-14 h-14 rounded-2xl bg-[#f1edec] flex items-center justify-center mb-5">
      ...
      <div className="flex gap-3">
        ...
        <a
          href="/dashboard"
          className="px-5 py-2.5 rounded-lg border border-[#cfc5bd] text-sm font-medium text-[#4c4640] hover:bg-[#f1edec] transition"
        >
          Go home
        </a>
      </div>
