  ...
  if (listings.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        <div className="w-16 h-16 rounded-full bg-[#F5EAE4] flex items-center justify-center mb-4">
        ...
        {profiles.map((profile) => {
          ...
          return (
            <Link
              ...
              className="bg-white rounded-2xl border border-[#cfc5bd] overflow-hidden hover:shadow-md hover:border-[#E8D5D0] transition-all group"
            >
              <div className="h-44 bg-[#EFE0D8] flex items-center justify-center relative overflow-hidden">
                {photoToShow ? (
                  <img
                    src={photoToShow}
                ...
                {lifestyleTags.length > 0 && (
                  <div className="flex flex-wrap gap-1 mt-2.5">
                    {lifestyleTags.slice(0, 2).map((tag) => (
                      <span
                        key={tag}
                        className="text-[10px] px-2 py-0.5 rounded-full bg-[#EFE0D8] text-[#4c4640] border border-[#cfc5bd]"
                      >
                        {tag}
                      </span>
                    ))}
