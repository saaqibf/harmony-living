...
const inputCls = 'block w-full rounded-xl border border-[#cfc5bd] bg-[#f7f3f1] px-4 py-3 text-sm text-[#1c1b1b] outline-none transition focus:border-[#2d4a3e] focus:ring-2 focus:ring-[#2d4a3e]/15';
      ...
      <div className="flex flex-wrap gap-5 pt-1">
        <label className="flex items-center gap-2.5 text-sm text-[#1c1b1b] cursor-pointer">
          <input type="checkbox" checked={smokingRoommate} onChange={(e) => setSmokingRoommate(e.target.checked)}
            className="w-4 h-4 rounded border-[#cfc5bd] accent-[#2d4a3e]" />
          Smoking roommate OK
        </label>
        <label className="flex items-center gap-2.5 text-sm text-[#1c1b1b] cursor-pointer">
