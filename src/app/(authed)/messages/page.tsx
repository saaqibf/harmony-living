export default function MessagesPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center p-8 bg-[#fdf8f7]">
      ...
      <p className="text-sm text-[#7d766f]">Choose from your messages on the left to start chatting.</p>
    </div>
  );
}
