...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#fdfbfc]">
      {/* Nav */}
      <nav className="bg-white/90 backdrop-blur-sm border-b border-[#E8D5D0] sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-6 md:px-10 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="text-sm font-medium text-[#4c4640] hover:text-[#1c1b1b] px-4 py-2 rounded-lg hover:bg-[#F9F0EE] transition-colors"
            >
              Log in
            </Link>
            <Link
              href="/signup"
              className="text-sm font-semibold bg-[#A86472] text-white px-5 py-2.5 rounded-lg hover:bg-[#8A505E] transition-colors"
            >
              Get started
            </Link>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-10 pt-20 pb-24 md:pt-28 md:pb-32">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div
              className="inline-flex items-center gap-2 bg-[#F9F0EE] text-[#A86472] text-xs font-semibold px-4 py-2 rounded-full border border-[#E8D5D0] mb-8 animate-fade-in"
              style={{ animationDelay: '0s' }}
            >
              <span className="w-1.5 h-1.5 rounded-full bg-[#A86472]" />
            ...
            >
              Find a home<br />
              where you truly<br />
              <em className="text-[#A86472] not-italic">belong.</em>
            </h1>
            ...
            >
              <Link
                href="/signup"
                className="inline-flex items-center justify-center bg-[#A86472] text-white font-semibold px-7 py-3.5 rounded-xl hover:bg-[#8A505E] transition-colors text-sm"
              >
                Find your match. It&apos;s free.
              </Link>
              <Link
                href="/listings"
                className="inline-flex items-center justify-center bg-white text-[#1c1b1b] font-medium px-7 py-3.5 rounded-xl border border-[#cfc5bd] hover:bg-[#F9F0EE] hover:border-[#E8D5D0] transition-colors text-sm"
              >
                Browse rooms
              </Link>
            </div>
          ...
          <div
            ...
            style={{ animationDelay: '0.2s' }}
          >
            <div className="bg-gradient-to-br from-[#A86472] to-[#1A0A14] rounded-2xl col-span-1 row-span-2 overflow-hidden relative flex flex-col justify-end p-5">
            ...
            <div className="bg-[#F9F0EE] rounded-2xl flex flex-col items-center justify-center p-4 border border-[#E8D5D0]">
              <div className="w-10 h-10 rounded-full bg-[#A86472] flex items-center justify-center mb-2">
      ...
      {/* How it works */}
      <section className="bg-white border-y border-[#E8D5D0] py-20 px-6 md:px-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-[#A86472] text-xs font-semibold uppercase tracking-widest mb-3">How it works</p>
            <h2 className="font-serif font-semibold text-[#1c1b1b] text-3xl md:text-4xl">Finding harmony is simple</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {HOW_IT_WORKS.map((s) => (
              <div key={s.step} className="relative">
                <span className="text-7xl font-bold text-[#A86472]/10 leading-none select-none absolute -top-4 -left-2 font-mono">{s.step}</span>
                <div className="relative pt-8">
                  <div className="w-8 h-8 rounded-full bg-[#A86472] text-white flex items-center justify-center text-xs font-bold font-mono mb-4">{s.step}</div>
      ...
      {/* Values */}
      <section className="py-20 px-6 md:px-10 bg-gradient-to-b from-[#fdfbfc] to-[#F9F0EE]/40">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#A86472] text-xs font-semibold uppercase tracking-widest mb-3">Our promise</p>
            <h2 className="font-serif font-semibold text-[#1c1b1b] text-3xl md:text-4xl">Built for real life</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-5">
            {[
              { icon: '🔍', title: 'Compatibility first', body: 'Lifestyle, schedule, cleanliness, and values, matched thoughtfully and not randomly.' },
              ...
              <div key={v.title} className="bg-white rounded-2xl p-7 border border-[#E8D5D0] hover:shadow-sm transition-shadow">
                <div className="w-12 h-12 rounded-xl bg-[#F9F0EE] flex items-center justify-center text-2xl mb-5">{v.icon}</div>
      ...
      <section className="bg-white border-y border-[#E8D5D0] py-20 px-6 md:px-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#A86472] text-xs font-semibold uppercase tracking-widest mb-3">Stories</p>
            <h2 className="font-serif font-semibold text-[#1c1b1b] text-3xl md:text-4xl">Real people, real harmony</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-5">
            {TESTIMONIALS.map((t) => (
              <div key={t.name} className="bg-[#F9F0EE] rounded-2xl p-7 border border-[#E8D5D0]">
                <div className="text-3xl text-[#A86472] font-serif leading-none mb-4">&ldquo;</div>
      ...
      <section className="px-6 md:px-10 py-20">
        <div className="max-w-2xl mx-auto bg-gradient-to-br from-[#A86472] to-[#1A0A14] rounded-2xl px-8 py-16 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center justify-center bg-white text-[#A86472] font-semibold px-8 py-3.5 rounded-xl hover:bg-[#F9F0EE] transition-colors text-sm"
            >
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-[#E8D5D0] px-6 md:px-10 py-8">
